...
switch ($_GET["p"]){
  case 'facebook':
        $config = ['callback' => "http://localhost/Github/visualizolaweb/Project-Inkside/cloud/auth.php?p=facebook",'keys' => ['id' => '697119137130415', 'secret' => '18f0758b3f8db9514f6a063830cc46ac']];
        try {
  ...
  case 'twitter':
        $config = ['callback' => "http://localhost/Github/visualizolaweb/Project-Inkside/cloud/auth.php?p=twitter",'keys' => ['key' => 'f5rHQUr3JME44O64p8b3do3XW', 'secret' => 'L87hbt5TiMnUsAU77Ma100SVt2aUwDWzhi0CXWhPPKpBL1VVZ4']];
        try {
