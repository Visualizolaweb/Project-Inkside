<?php
  ...
  echo "seguidores " . $misSeguidores['seg_seguidores'];

  $poemasContent = $seguidores->miComunidad($misSeguidores['seg_seguidores']);
?>
    ...
    <div class="col l12">
      ...
      <div class="row">
        <div class="col m12 header-section">
          <h5 class='title'>Mi Comunidad de Escritores InkSide </h5>
        </div>
      </div>
