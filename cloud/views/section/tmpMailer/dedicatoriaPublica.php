...
<h2 style="color:#00bcd4;line-height:30px;margin-bottom:12px;margin:0 0 12px">Te han dedicado un <span class="il">poema.</span></h2>
<p style="font-size:17px;line-height:24px;margin:0 0 16px">
Hola '.ucwords($nombre_destino).', '.ucwords($nombre_origen).' te ha dedicado el poema "'.$pub_nombre.'" el cual se encuentra en inksidepoesia.com,
</p>
<p style="font-size:17px;line-height:24px;margin:0 0 16px">
<span class="il">Para poder leerlo debes hacer clic en el boton "Quiero mi poema".</span>
</p>
<p style="font-size:17px;line-height:24px;margin:0 0 16px"></p>
<a href="'.urlsitio.'pubID'.$pub_codigo.'" style="text-decoration:none;margin:0 0 16px;cursor: pointer;color:white;border-radius:8px;border:2px solid #26c6da;height:20%;background-color:#00bcd4;width:42%;height:8vh;font-size:3vh;margin-top:1%;font-family:sans-serif; display:block; text-align:center;line-height:2.5">QUIERO MI POEMA</a>
<p style="font-size:17px;line-height:24px;margin:0 0 16px">
