<div class="container">
  <div class="row">
    <div class="col m9">
      <div class="fechaPublicacion" style="border-top: 1px solid #ddd; padding-top:5px; width:100%;">Poema publicado hace 2 días</div>
      <h1 style="color: #208d8f; font-size: 32px; margin-top: 8px; margin-bottom: 8px">Poema del moribundo que no tiene quién le escriba</h1>

      <div class="compartir row" style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 17px 0;">
        <div class="col m6"><button class="waves-effect waves-light btn primary-button z-depth-0 btn-icon"><i class="fa fa-users icon-button"></i> Dedicar este poema</button></div>
      ...
      <div class="tags" style="border-bottom:1px solid #ddd; padding-bottom:10px; margin-bottom:10px;">
        ...
        <ul>
          <li style="display:inline; padding:5px 8px; color: white" class="pink accent-3">Amor</li>
      ...
      <div class="autor">
        <div class="row">
          <div class="col m12 center">
            <img width="100" src="website/views/assets/images/perfil/imagen_20170328-22212610682.jpg" class="circle">
            <h2 style="font-size: 20px; font-weight: bold; margin-bottom: 0;">Guille Valencia</h2>
            <p>Padre orgulloso! algo Geek, algo Gamer, me encanta aprender y enseñar.</p>
               ...
               <div class="col s12">
                 <div class="card blue-grey darken-1">
                   <div class="card-content white-text" style="padding:10px;">
                     <span class="card-title" style="font-size: 18px; font-weight: bold">Me gusta cuando callas</span>
                     <p style="font-size: 13px">Me gustas cuando callas porque estás como ausente, y me oyes desde lejos, y mi voz no te toca...</p>
                   </div>
                   <div class="card-action" style="padding:10px;">
                     <a href="#" style="text-align:right">Leer Poema</a>
                   </div>
                 </div>
               </div>
             </div>
